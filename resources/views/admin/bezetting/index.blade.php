    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Tabel pohon bezetting pegawai seluruh OPD</p>
            </div>
            <a href="{{ route('admin.bezetting.export') }}" class="mt-3 sm:mt-0 inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:outline-none transition">
                Export Excel
            </a>
        </div>
