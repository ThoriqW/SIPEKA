...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Edit UNOR</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-2xl">
            <form method="POST" action="{{ route('admin.opd.update', $opd) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_unor" id="nama_unor"
                           value="{{ old('nama_unor', $opd->nama_unor) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="kode_unor" id="kode_unor"
                           value="{{ old('kode_unor', $opd->kode_unor) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="singkatan" id="singkatan"
                           value="{{ old('singkatan', $opd->singkatan) }}" maxlength="10"
                ...
                <div class="mb-6">
                    ...
                    <select name="parent_id" id="parent_id"
                        ...
                        <option value="{{ $id }}" {{ (old('parent_id', $opd->parent_id) == $id) ? 'selected' : '' }}>{{ $nama }}</option>
                        @endforeach
                    </select>
