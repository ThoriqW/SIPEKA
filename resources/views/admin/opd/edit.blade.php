...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Edit OPD</h1>
            <p class="text-sm text-gray-500 mt-1"><a href="{{ route('admin.opd.index') }}" class="hover:text-gray-700">OPD</a> / Edit</p>
        </div>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('admin.opd.update', $opd) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_opd" value="{{ old('nama_opd', $opd->nama_opd) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('nama_opd') border-red-500 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="kode_opd" value="{{ old('kode_opd', $opd->kode_opd) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('kode_opd') border-red-500 @enderror">
