...
<div class="py-6">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1"><a href="{{ route('admin.tugas-tambahan.index') }}" class="hover:text-gray-700">Master Tugas Tambahan</a> / Tambah</p>
        </div>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form method="POST" action="{{ route('admin.tugas-tambahan.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_tugas" value="{{ old('nama_tugas') }}"
