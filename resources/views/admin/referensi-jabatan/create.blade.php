...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Tambah Referensi Jabatan</h1>
            <p class="text-sm text-gray-500 mt-1"><a href="{{ route('admin.referensi-jabatan.index') }}" class="hover:text-gray-700">Referensi Jabatan</a> / Tambah</p>
        </div>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"
             x-data="{ jenis: '{{ old('jenis_jabatan', '') }}' }">
            <form action="{{ route('admin.referensi-jabatan.store') }}" method="POST">
                @csrf
