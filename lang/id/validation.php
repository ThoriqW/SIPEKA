...
return [
    ...
    */
    ...
    'contains'          => ':attribute tidak berisi nilai yang wajib.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Language Lines — Bahasa Indonesia
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Attribute Names — Label Indonesia untuk Nama Field
    |--------------------------------------------------------------------------
    */

    'attributes' => [
        'nama_unor'              => 'Unit Organisasi',
        'kode_unor'              => 'Kode UNOR',
        'parent_id'              => 'Unit Organisasi Induk',
        'nama'                   => 'Nama',
        'nip'                    => 'NIP',
        'nama_jabatan'           => 'Nama Jabatan',
        'jenis_jabatan'          => 'Jenis Jabatan',
        'jenjang'                => 'Jenjang',
        'sub_jabatan'            => 'Sub Jabatan',
        ...
        'jabatan_id'             => 'Jabatan',
        'induk_id'               => 'OPD',
        'unor_id'                => 'Unit Organisasi',
        'tugas_tambahan_id'      => 'Tugas Tambahan',
